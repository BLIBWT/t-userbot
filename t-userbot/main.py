...
def get_phones(arguments):
    ...
    phones.update(map(lambda f: f[18:-8],
                      filter(lambda f: f.startswith("t-userbot-") and f.endswith(".session"),
    ...
    if not clients and not phones:
        if web:
            ...
            try:
                ...
                print()  # noqa: T001
                print("In addition, you seem to have forked the t-userbot repo. THIS IS WRONG!")  # noqa: T001
                print("You should remove the forked repo, and read https://BLIBWT.github.io")  # noqa: T001
                print()  # noqa: T001
